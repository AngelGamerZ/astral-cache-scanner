...
public static class SetupTests {
    ...
    public static int Run(string testRoot,string clientDirectory) {
        ...
        try {
            ...
            Check(LiveReader.SupportedHash("CC685C8EA7B84300A99B8BE0FAE84CB82287A85C14C6A84F4CA04042EC629B65"),"September 12 client is supported");
            ClientCompatibilityTests.Run(clientDirectory,run);
            ...
            File.WriteAllText(report,"PASS: known clients and normalized compatibility profile; harmless metadata/resource changes accepted; code/data/layout/trailing mutations and malformed PE rejected; first-launch lock; wrong folder and unsupported EXE rejected without saving; explicit valid selection unlocks; no auto-scan; persistence/reload; atomic replacement; missing saved path and malformed settings relock. Isolated settings only; user's first-run setup not prefilled.\r\n");return 0;
