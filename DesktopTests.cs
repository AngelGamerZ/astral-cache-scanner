...
public static class DesktopTests {
    ...
    public static int Run(string root) {
        ...
        try {
            ...
            Check(ReleaseInfo.Describe("{\"tag_name\":\"v1.6.0\"}").StartsWith("Update verfügbar"),"New release");Check(ReleaseInfo.Describe("{\"tag_name\":\"v1.5.3\"}").StartsWith("Aktuell"),"Same release");Check(ReleaseInfo.Describe("{\"tag_name\":\"v1.0.0\"}").StartsWith("Installiert"),"Do not downgrade");
