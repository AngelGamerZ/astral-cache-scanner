...
public static class MemoryTests {
    ...
    public static int Run(string root) {
        ...
        try {
            ...
            File.WriteAllText(report,"PASS: discovery/deduplication; retained after fly-by/partial scan/restart; updated distance; map/realm/character and instance separation; unrelated loot ignored; early close and unobserved autoloot retain find; two empty observations after contents complete exact GUID; no immediate resurrection; completion persistence; reappearance; manual completion/undo; no demo/export persistence; disk failure/recovery; corrupt data preserved. Synthetic isolated fixtures, no game input.\r\n");return 0;
